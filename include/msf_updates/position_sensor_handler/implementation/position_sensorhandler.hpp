...
PositionSensorHandler<MEASUREMENT_TYPE, MANAGER_TYPE>::PositionSensorHandler(
  ...
  use_fixed_covariance_ = Config::get<bool>(parameternamespace + "/position_use_fixed_covariance", false);
  provides_absolute_measurements_ = Config::get<bool>(parameternamespace + "/position_absolute_measurements", false);
...
void PositionSensorHandler<MEASUREMENT_TYPE, MANAGER_TYPE>::ProcessPositionMeasurement(
  ...
  if (mngr) {
    bool position_fixed_p_ip = Config::get<bool>(parameternamespace_ + "/pose_fixed_p_ip", true);
    if (position_fixed_p_ip) {
